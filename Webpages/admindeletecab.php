...
ob_start();
if(isset($_POST['cabnumber'])){
  if(!empty($_POST['cabnumber'])){
    $id = ($_POST['cabnumber']);
    
    $query = "DELETE FROM CAB WHERE CAB_NUMBER='$id'";
...
<head>
  ...
  <title>Deletion from CAB table</title>
  <link rel="stylesheet" href="css/style.css">
</head>
<body>
  <section class="container">
    <div class="login">
      <h1>Deletion from CAB Table </h1>
      <form method="post">
